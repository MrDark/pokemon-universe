...
type PU_Message_AddPlayer struct {
	player *PU_Player
}

func NewAddPlayerMessage(_packet *punet.Packet) *PU_Message_AddPlayer {
	msg := &PU_Message_AddPlayer{}
	msg.ReadPacket(_packet)
	return msg
}

func (m *PU_Message_AddPlayer) ReadPacket(_packet *punet.Packet) os.Error {
