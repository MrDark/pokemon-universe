...
func (m *SendPlayerData) WritePacket() (*pnet.Packet, os.Error) {
	...
	packet.AddUint32(uint32(m.Outfit.GetOutfitColour(OUTFIT_UPPER)))
	packet.AddUint8(uint8(m.Outfit.GetOutfitStyle(OUTFIT_NEK)))
	packet.AddUint32(uint32(m.Outfit.GetOutfitColour(OUTFIT_NEK)))
	packet.AddUint8(uint8(m.Outfit.GetOutfitStyle(OUTFIT_HEAD)))
	packet.AddUint32(uint32(m.Outfit.GetOutfitColour(OUTFIT_HEAD)))
	packet.AddUint8(uint8(m.Outfit.GetOutfitStyle(OUTFIT_FEET)))
	packet.AddUint32(uint32(m.Outfit.GetOutfitColour(OUTFIT_FEET)))
	packet.AddUint8(uint8(m.Outfit.GetOutfitStyle(OUTFIT_LOWER)))
	packet.AddUint32(uint32(m.Outfit.GetOutfitColour(OUTFIT_LOWER)))
