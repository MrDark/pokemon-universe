...
// ReadConfigFile reads a file and returns a new config struct.
// This struct can be queried with GetString, etc.
...
// ReadConfigBytes reads an array of bytes and returns a new config struct.
// This struct can be queried with GetString, etc.
...
// Read reads an io.Reader and returns a config struct. 
...
// Strip all commentary lines from given string
